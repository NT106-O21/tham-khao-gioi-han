...
namespace Lab1
{
    public partial class Bai5 : Form
    {
        ...
        public Bai5()
        {
            ...
            phims.Add(new Phim() { Ten = "Đào, phở và piano", GiaVe = 45000, PhongChieu = new int[] { 1, 2 } });
            phims.Add(new Phim() { Ten = "Mai", GiaVe = 100000, PhongChieu = new int[] { 1, 2, 3 } });
            phims.Add(new Phim() { Ten = "Gặp lại chị bầu", GiaVe = 70000, PhongChieu = new int[] { 2 } });
            phims.Add(new Phim() { Ten = "Tarot", GiaVe = 90000, PhongChieu = new int[] { 1 } });
        ...
        private void Bai5_Load(object sender, EventArgs e)
        {
            ...
            label5.Text = selectedPhim.Ten + " | Giá vé chuẩn: " + selectedPhim.GiaVe.ToString();
        }
    }
}
